                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" align="center"
                                ...
                                <tr>
                                    <td align="center" style="text-align:center;">
                                        <a href="{{$url}}"
                                           style="display:block; width:100%; color: #fff; font-family: 'Raleway', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 600;text-decoration:none !important;"><br/>{{__('messages.reset_pw_btn', [], $locale)}}
                                            <br/>&nbsp;</a>
                                    </td>
                                </tr>
                            </table>
        ...
        <tr>
            <td>
                <table align="center" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="color: #777; font-family: 'Raleway', Helvetica, Arial, sans-serif; line-height: 1.5em; font-size: 18px; font-weight: 600; ">
                            {{__('messages.reset_pw_ignore', [], $locale)}}
                        </td>
                    </tr>
                    <!--  end section title  -->
        ...
        <tr>
            <td>
                <table align="center" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="color: #777; font-family: 'Raleway', Helvetica, Arial, sans-serif; line-height: 1.5em; font-size: 18px; font-weight: 600; ">
                            {{__('messages.reset_pw_help', [], $locale)}}
                        </td>
                    </tr>
                    <!--  end section title  -->
